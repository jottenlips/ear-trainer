...
const translations = {
  ...
  // Intonation
  'intonation.title': { en: 'Intonation', es: 'Entonación' },
  'intonation.subtitle': { en: 'Sing in key over chord changes', es: 'Canta en tono sobre cambios de acordes' },
  'intonation.desc': { en: 'Sing in key — how\'s your pitch?', es: '¿Cantas afinado? Practica tu entonación' },
  'intonation.key': { en: 'Key', es: 'Tonalidad' },
  'intonation.major': { en: 'Major', es: 'Mayor' },
  'intonation.minor': { en: 'Minor', es: 'Menor' },
  'intonation.flat': { en: '♭ Flat', es: '♭ Bemol' },
  'intonation.sharp': { en: '♯ Sharp', es: '♯ Sostenido' },
  'intonation.inTune': { en: 'In Tune', es: 'Afinado' },
  'intonation.sing': { en: 'Sing a note...', es: 'Canta una nota...' },
  'intonation.offKey': { en: 'Off Key', es: 'Desafinado' },
  'intonation.avgCents': { en: 'Avg. Cents', es: 'Cents Prom.' },
  'intonation.mode': { en: 'Mode', es: 'Modo' },
  'intonation.modeFree': { en: 'Free', es: 'Libre' },
  'intonation.modeMelody': { en: 'Melody', es: 'Melodía' },
  'intonation.listen': { en: 'Listen...', es: 'Escucha...' },
  'intonation.yourTurn': { en: 'Your turn!', es: '¡Tu turno!' },
  'intonation.newMelody': { en: 'New Melody', es: 'Nueva Melodía' },
  'intonation.pause': { en: '⏸ Pause', es: '⏸ Pausa' },
  'intonation.resume': { en: '▶ Resume', es: '▶ Reanudar' },
  'intonation.tips': { en: 'Tips for Singing in Tune', es: 'Consejos para Cantar Afinado' },
  'intonation.tip1.title': { en: 'Hear it first', es: 'Escúchala primero' },
  'intonation.tip1.desc': {
    en: 'Tap a scale note to hear the pitch, then "hear" it in your head before singing. This is called audiation.',
    es: 'Toca una nota de la escala para escuchar el tono, luego "escúchala" en tu cabeza antes de cantar. Esto se llama audiación.',
  },
  'intonation.tip2.title': { en: 'Start on the root', es: 'Empieza en la tónica' },
  'intonation.tip2.desc': {
    en: 'The tonic is the easiest note to lock in because the chord reinforces it. Build confidence there first.',
    es: 'La tónica es la nota más fácil de afinar porque el acorde la refuerza. Empieza por ahí.',
  },
  'intonation.tip3.title': { en: 'Slide up into notes', es: 'Deslízate hacia las notas' },
  'intonation.tip3.desc': {
    en: 'Most people sing slightly flat. Approaching from just below and adjusting up tends to land more accurately.',
    es: 'La mayoría canta ligeramente bajo. Acercarse desde abajo y ajustar hacia arriba tiende a ser más preciso.',
  },
  'intonation.tip4.title': { en: 'Sustain, don\'t stab', es: 'Sostén, no ataques' },
  'intonation.tip4.desc': {
    en: 'Hold notes so you can adjust in real time. Short jabs give you no chance to correct. Use the meter to dial it in.',
    es: 'Sostén las notas para ajustar en tiempo real. Notas cortas no te dan oportunidad de corregir. Usa el medidor.',
  },
  'intonation.tip5.title': { en: 'Use open vowels', es: 'Usa vocales abiertas' },
  'intonation.tip5.desc': {
    en: '"Ah" and "oh" are easier to pitch than closed vowels. Humming also works — your skull gives bone conduction feedback.',
    es: '"Ah" y "oh" son más fáciles de afinar que vocales cerradas. Tararear también funciona — tu cráneo da retroalimentación.',
  },
  'intonation.tip6.title': { en: 'Breathe from your diaphragm', es: 'Respira desde el diafragma' },
  'intonation.tip6.desc': {
    en: 'Pitch wavers when you run out of air. Support from below keeps it steady.',
    es: 'La afinación tiembla cuando te quedas sin aire. El soporte desde abajo la mantiene estable.',
  },
  'intonation.tip7.title': { en: 'Match the octave', es: 'Encuentra tu octava' },
  'intonation.tip7.desc': {
    en: 'If the meter jumps wildly, you might be an octave off. Use the two-octave buttons to find your comfortable range.',
    es: 'Si el medidor salta mucho, podrías estar una octava fuera. Usa los botones de dos octavas para encontrar tu rango.',
  },
  'intonation.progression': { en: 'Progression', es: 'Progresión' },
  'prog.oneChord': { en: 'One Chord', es: 'Un Acorde' },
  'prog.twoChord': { en: 'Two Chord', es: 'Dos Acordes' },
  'prog.pop': { en: 'Pop', es: 'Pop' },
  'prog.blues': { en: 'Blues', es: 'Blues' },
  'prog.jazz': { en: 'Jazz', es: 'Jazz' },
  'prog.fifties': { en: '50s', es: 'Años 50' },
  'prog.axis': { en: 'Anthem', es: 'Himno' },
  'prog.country': { en: 'Country', es: 'Country' },
  'prog.rock': { en: 'Rock', es: 'Rock' },
  'prog.andalusian': { en: 'Andalusian', es: 'Andaluz' },
  'prog.epic': { en: 'Epic Minor', es: 'Menor Épico' },
  'prog.minorBlues': { en: 'Minor Blues', es: 'Blues Menor' },
